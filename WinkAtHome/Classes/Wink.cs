...
public class Wink
{
    ...
    public static bool validateWinkCredentials(string username, string password)
    {
        ...
        {
            EventLog.WriteEntry("WinkAtHome.Wink.validateWinkCredentials", ex.Message, EventLogEntryType.Error);
            return false;
        }
    }
    ...
    public class Device
    {
        ...
        public static string setDeviceDisplayName(string DeviceID, string DisplayName)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setDeviceDisplayName", ex.Message, EventLogEntryType.Error);
                return null;
            }
        }
        public static int setDevicePosition(string DeviceID, int Position)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setDevicePosition", ex.Message, EventLogEntryType.Error);
                return -1;
            }
        }
...
#region Shortcut
    public class Shortcut
    {
        ...
        public static string setShortcutDisplayName(string ShortcutID, string DisplayName)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setShortcutDisplayName", ex.Message, EventLogEntryType.Error);
                return null;
            }
        }
        public static int setShortcutPosition(string ShortcutID, int Position)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setShortcutPosition", ex.Message, EventLogEntryType.Error);
                return -1;
            }
        }
...
#region Group 
    public class Group
    {
        ...
        public static string setGroupDisplayName(string GroupID, string DisplayName)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setGroupDisplayName", ex.Message, EventLogEntryType.Error);
                return null;
            }
        }
        public static int setGroupPosition(string GroupID, int Position)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setGroupPosition", ex.Message, EventLogEntryType.Error);
                return -1;
            }
        }
...
#region Robot
    public class Robot
    {
        ...
        public static string setRobotDisplayName(string RobotID, string DisplayName)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setRobotDisplayName", ex.Message, EventLogEntryType.Error);
                return null;
            }
        }
        public static int setRobotPosition(string RobotID, int Position)
        {
            ...
            {
                EventLog.WriteEntry("WinkAtHome.Wink.setRobotPosition", ex.Message, EventLogEntryType.Error);
                return -1;
            }
        }
    }
